package com.celalkorucu.survivorbird;
...
public class SurvivorBird extends ApplicationAdapter {
    ...
    public void render() {
        ...
        if(gameState == 1) {
            ...
            font2.draw(batch , "Game Over ! Tab To Play Again" , Gdx.graphics.getWidth()/2 , Gdx.graphics.getHeight()/2);
